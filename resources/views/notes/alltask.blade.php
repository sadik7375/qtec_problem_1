...
>
    ...
    <div class="search-input" style="margin-bottom: 20px; margin-left: 20px;">
        <form action="{{ route('notes.search') }}" method="GET">
            <input type="text" name="query" placeholder="Search..." class="form-control" style="margin-bottom: 15px" >
    ...
    <a href="{{route('notes.create')}}"  ><button type="submit" class="btn btn-primary" style="margin-bottom: 20px" >Add Notes</button></a>
